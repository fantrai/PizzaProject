...
@dso_cache = dso_local local_unnamed_addr global [486 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 583617275, ; hash 0x22c94afb, from name: libaot-Pizza.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 966390559, ; hash 0x3999f31f, from name: libaot-Pizza
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Pizza.dll.so
		ptr null; void* handle (0x0)
	}, ; 100
	...
	%struct.DSOCacheEntry {
		i64 1072949062, ; hash 0x3ff3e746, from name: Pizza
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Pizza.dll.so
		ptr null; void* handle (0x0)
	}, ; 115
	...
	%struct.DSOCacheEntry {
		i64 1372831500, ; hash 0x51d3bf0c, from name: Pizza.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Pizza.dll.so
		ptr null; void* handle (0x0)
	}, ; 145
	...
	%struct.DSOCacheEntry {
		i64 2646312788, ; hash 0x9dbb8754, from name: aot-Pizza
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Pizza.dll.so
		ptr null; void* handle (0x0)
	}, ; 301
	...
	%struct.DSOCacheEntry {
		i64 3802797557, ; hash 0xe2aa15f5, from name: aot-Pizza.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Pizza.dll.so
		ptr null; void* handle (0x0)
	}, ; 429
