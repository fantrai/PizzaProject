...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100670627, ; uint32_t jnienv_initialize_method_token (0x6001ca3)
	i32 100670626, ; uint32_t jnienv_registerjninatives_method_token (0x6001ca2)
...
@dso_cache = dso_local local_unnamed_addr global [486 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.76_name, ; name: libaot-System.Web.HttpUtility.dll.so
		ptr null; void* handle (0x0)
	}, ; 11
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3399411752369619480, ; hash 0x2f2d22fa59478218, from name: aot-Pizza.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Pizza.dll.so
		ptr null; void* handle (0x0)
	}, ; 88
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4240501964172272640, ; hash 0x3ad94a11bbd5a400, from name: Pizza.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Pizza.dll.so
		ptr null; void* handle (0x0)
	}, ; 112
	...
	%struct.DSOCacheEntry {
		i64 7018285407453159022, ; hash 0x6165f564c38d9e6e, from name: libaot-Pizza
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Pizza.dll.so
		ptr null; void* handle (0x0)
	}, ; 163
	...
	%struct.DSOCacheEntry {
		i64 9120841355445270785, ; hash 0x7e93bce37401f901, from name: Pizza
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Pizza.dll.so
		ptr null; void* handle (0x0)
	}, ; 236
	...
	%struct.DSOCacheEntry {
		i64 9430030524795486055, ; hash 0x82de32ccc3867f67, from name: libaot-Pizza.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Pizza.dll.so
		ptr null; void* handle (0x0)
	}, ; 243
	...
	%struct.DSOCacheEntry {
		i64 16936929905460904808, ; hash 0xeb0c100368b00368, from name: aot-Pizza
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Pizza.dll.so
		ptr null; void* handle (0x0)
	}, ; 446
...
@.env.3 = private unnamed_addr constant [37 x i8] c"4aab5e98-259c-4846-9381-b1dbe40cc6bd\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [22 x i8] c"com.companyname.pizza\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [20 x i8] c"libaot-Pizza.dll.so\00", align 16
...
@.DSOCacheEntry.76_name = private unnamed_addr constant [37 x i8] c"libaot-System.Web.HttpUtility.dll.so\00", align 16
